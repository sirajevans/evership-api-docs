export const metadata = {
  title: 'Errors',
  description: 'Understand Evership API error codes and status responses. Learn how to handle common errors and debug API integration issues effectively.',
  keywords: [
    'Evership API errors',
    'error codes',
    'API troubleshooting',
  ...
  openGraph: {
    title: 'Errors · Evership',
    description: 'Understand Evership API error codes and status responses. Learn how to handle common errors and debug API integration issues effectively.',
    url: 'https://developers.evership.co.za/errors',
  },
  twitter: {
...
<Note>
  ...
  your code before contacting Evership support.
</Note>
...
<Row>
  <Col>
    ...
    Whenever a request is unsuccessful, the Evership API will return an error response with an error type and message. You can use this information to understand better what has gone wrong and how to fix it. Most of the error messages are pretty helpful and actionable.

    Here is a list of the two error types supported by the Evership API — use these to understand what you have done wrong.
  ...
  <Col>
    ...
    ```bash {{ title: "Error response" }}
    {
      ...
      "documentation_url": "https://api.evership.app/v1/shipments"
    }
    ```
