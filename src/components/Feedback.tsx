...
>(function FeedbackThanks({ className, ...props }, ref) {
  return (
    ...
    >
      <div className="flex items-center gap-3 rounded-full bg-violet-50/50 py-1 pr-3 pl-1.5 text-sm text-violet-900 ring-1 ring-violet-500/20 ring-inset dark:bg-violet-500/5 dark:text-violet-200 dark:ring-violet-500/30">
