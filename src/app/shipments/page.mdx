export const metadata = {
  title: 'Shipments',
  description: 'Create, manage, and track shipments with the Evership API. Learn how to programmatically create shipments, purchase labels, and integrate shipping workflows into your applications.',
  keywords: [
    'Evership shipments API',
    'create shipment',
  ...
  openGraph: {
    title: 'Shipments · Evership',
    description: 'Create, manage, and track shipments with the Evership API. Learn how to programmatically create shipments, purchase labels, and integrate shipping workflows into your applications.',
    url: 'https://developers.evership.co.za/shipments',
  },
  twitter: {
...
## Create Shipment {{ tag: 'POST', label: 'api.evership.app/v1/shipments' }}
...
## Purchase Shipment {{ tag: 'POST', label: 'api.evership.app/v1/purchase-shipment' }}
...
## Edit Shipment {{ tag: 'PUT', label: 'api.evership.app/v1/shipments/{shipment_id}' }}
...
## List Shipments {{ tag: 'GET', label: 'api.evership.app/v1/list-shipments' }}
...
## Retrieve Shipments {{ tag: 'GET', label: 'api.evership.app/v1/shipments/{shipment_id}' }}
...
## Cancel Shipments {{ tag: 'POST', label: 'api.evership.app/v1/cancel-shipment/{shipment_id}' }}
...
## Delete Shipments {{ tag: 'DELETE', label: 'api.evership.app/v1/shipments/{shipment_id}' }}
