...
## Create Shipment {{ tag: 'POST', label: 'api.evership.co.za/v1/shipments' }}
...
## Retrieve Shipments {{ tag: 'GET', label: 'api.evership.app/shipments/{shipment_id}' }}
...
## Cancel Shipments {{ tag: 'POST', label: 'api.evership.co.za/v1/cancel-shipment/{shipment_id}' }}
...
## Delete Shipments {{ tag: 'DELETE', label: 'api.evership.co.za/v1/shipments/{shipment_id}' }}
