...
<Properties>
  <Property name="provider" type="string">
    Name of the courier providing the service (e.g. "Fastway").
  </Property>
  <Property name="service" type="string">
    Name of the shipping service (e.g. "Express").
  </Property>
  <Property name="service_code" type="string">
    Internal service code used by Evership (e.g. "Express-001").
  </Property>
  <Property name="currency" type="string">
    3-letter ISO currency code (e.g. "ZAR").
  </Property>
  <Property name="amount" type="float">
    Total cost of the shipment using this rate.
  </Property>
  <Property name="estimated_delivery" type="timestamp">
    ISO 8601 date/time estimate for when the shipment will arrive.
  </Property>
  <Property name="cutoff_time" type="timestamp">
    ISO 8601 timestamp indicating the latest time this service can be booked for same-day dispatch.
  </Property>
  <Property name="collection_address" type="object">
    Normalized version of the submitted pickup address.
  </Property>
  <Property name="delivery_address" type="object">
    Normalized version of the submitted destination address.
  </Property>
</Properties>
---

## Validate address {{ tag: 'POST', label: 'https://api.evership.app/v1/validate-address' }}
...
<Row>
  ...
  <Col sticky>
    ...
    ### Example Request
    <CodeGroup title="Request" tag="GET" label="/validate-address">
    ```
    GET https://api.evership.app/v1/validate-address?address1=Unit%2012&address2=113%20Loop%20St&suburb=Cape%20Town&province=Western%20Cape&postal_code=8000&country=South%20Africa
    ```
    </CodeGroup>
...
## Get Rates {{ tag: 'POST', label: 'https://www.api.evership.co.za/v1/rates' }}
